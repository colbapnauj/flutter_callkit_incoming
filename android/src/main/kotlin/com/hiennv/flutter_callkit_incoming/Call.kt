...
data class Data(val args: Map<String, Any?>) {
    ...
    fun toBundle(): Bundle {
        ...
        bundle.putString(CallkitConstants.EXTRA_CALLKIT_SERVICE_TYPE, serviceType)
        bundle.putString(CallkitConstants.EXTRA_CALLKIT_DATETIME, dateTime)
    ...
    companion object {
        ...
        fun fromBundle(bundle: Bundle): Data {
            ...
            data.serviceType =
                bundle.getString(CallkitConstants.EXTRA_CALLKIT_SERVICE_TYPE,"")
            data.dateTime =
                bundle.getString(CallkitConstants.EXTRA_CALLKIT_DATETIME,"")
