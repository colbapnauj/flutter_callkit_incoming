...
class CallkitIncomingActivity : Activity() {
    ...
    private fun incomingData(intent: Intent) {
        ...
        tvTitle.text = data?.getString(CallkitConstants.EXTRA_CALLKIT_TITLE, "Llamada Entrante")
        tvType.text = data?.getString(CallkitConstants.EXTRA_CALLKIT_SERVICE_TYPE, "")
        tvDateTime.text = data?.getString(CallkitConstants.EXTRA_CALLKIT_DATETIME, "")
